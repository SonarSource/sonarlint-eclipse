...
public class ProjectChangeBindingAction extends AbstractBindingAction {
  public ProjectChangeBindingAction(Shell shell, ISelectionProvider selectionProvider) {
    super(shell, selectionProvider, Messages.actionChangeBinding, SonarLintImages.SYNCED_IMG);
  }
