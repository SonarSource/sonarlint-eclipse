...
public class OrganizationProvider implements IContentProposalProvider {
  ...
  public IContentProposal[] getProposals(String contents, int position) {
    ...
    if (contents.isEmpty()) {
      var allUserOrgs = SonarLintBackendService.get().getBackend().getConnectionService().listUserOrganizations(new ListUserOrganizationsParams(model.getTransientRpcCrendentials()))
        .join();
