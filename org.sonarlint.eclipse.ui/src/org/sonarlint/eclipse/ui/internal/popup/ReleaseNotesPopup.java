 ...
 */
public class ReleaseNotesPopup extends AbstractSonarLintPopup {
  @Override
  protected String getMessage() {
    return "Thank you for installing / updating SonarLint. We invite you to learn about the recent changes by taking a"
  ...
  protected String getPopupShellTitle() {
    return "SonarLint - Release Notes";
  }
