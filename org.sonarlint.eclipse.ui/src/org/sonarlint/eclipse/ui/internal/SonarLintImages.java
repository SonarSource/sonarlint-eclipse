...
public class SonarLintImages {
  protected static final String IMPACT_FOLDER_PREFIX = "impact/";
  ...
  public static final Image IMG_ERROR = createImage("impact/blocker.png"); //$NON-NLS-1$
   ...
   */
  protected static class CompositeIssueImage extends CompositeImageDescriptor {
    @Nullable
  ...
  protected static ImageDescriptor createImageDescriptor(String key) {
    var imageRegistry = SonarLintUiPlugin.getDefault().getImageRegistry();
