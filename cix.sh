...
mvn -B -e -V clean verify -Dtarget.platform=$TARGET_PLATFORM -Dtycho.localArtifacts=ignore -Dtycho.disableP2Mirrors=true -Dsonarlint-eclipse.p2.url=$REPO_URL -Dsonar.runtimeVersion=$SQ_VERSION -DskipTests
