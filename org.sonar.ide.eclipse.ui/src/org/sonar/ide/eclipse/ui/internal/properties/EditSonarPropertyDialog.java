...
public class EditSonarPropertyDialog extends StatusDialog {
  ...
  private SonarProperty sonarProperty;
   ...
   */
  public EditSonarPropertyDialog(Shell parent, SonarProperty property, boolean edit, boolean isNameModifiable) {
    super(parent);
  ...
  protected void okPressed() {
    ...
    sonarProperty = new SonarProperty(name, fValueText.getText());
    super.okPressed();
  }
   ...
   */
  public SonarProperty getSonarProperty() {
