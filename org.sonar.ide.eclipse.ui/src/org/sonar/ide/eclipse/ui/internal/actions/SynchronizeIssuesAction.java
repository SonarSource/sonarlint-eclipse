...
public class SynchronizeIssuesAction implements IObjectActionDelegate {

  private static final Logger LOG = LoggerFactory.getLogger(SynchronizeIssuesAction.class);
  ...
  public void run(IAction action) {
    SynchronizeAllIssuesJob job = new SynchronizeAllIssuesJob(projects);
