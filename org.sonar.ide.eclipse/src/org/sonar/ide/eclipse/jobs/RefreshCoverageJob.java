...
public class RefreshCoverageJob extends Job {
    ...
    if (targetEditor != null) {
      ...
      if (doc != null) {
        ...
        for (final CoverageLine coverage : coverageLines) {
          ...
          try {
            if (doc.getNumberOfLines() > coverage.getLine()) {
              ...
              if (lineIsCovered) {
                ...
                model
                    .addAnnotation(new Annotation("org.sonar.ide.eclipse.noCoverageAnnotationType", false, getMessage(coverage)), position);
              }
            }
  ...
  protected final IDocument getDocument() {
    IDocumentProvider provider = targetEditor.getDocumentProvider();
    if (provider != null) {
