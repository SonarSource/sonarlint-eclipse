...
public class SonarLintDocumentation {
  ...
  private static final String BASE_DOCS_URL = "https://docs.sonarsource.com/sonarqube-for-eclipse";
  ...
  public static final String TROUBLESHOOTING_LINK = BASE_DOCS_URL + "/resources/troubleshooting/";
  public static final String ADVANCED_CONFIGURATION = BASE_DOCS_URL + "/connect-your-ide/advanced-configuration/";
